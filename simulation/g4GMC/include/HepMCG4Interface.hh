...
protected:
  ...
  std::unique_ptr<HepMC3::GenEvent> hepmcEvent; // (care for single event case only)
  ...
  virtual std::unique_ptr<HepMC3::GenEvent> GenerateHepMCEvent();
